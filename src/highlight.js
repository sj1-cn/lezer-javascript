...
export const jsHighlight = styleTags({
  ...
  "let var const using function type dict struct entity transaction tx relationship rt extends": t.definitionKeyword,
  ...
  "TypeDeclaration/DictDeclaration/StructDeclaration/EntityDeclaration/TransactionDeclaration/RelationshipDeclaration/VariableDefinition": t.definition(t.className),
  ...
  "interface implements namespace module declare": t.definitionKeyword,
